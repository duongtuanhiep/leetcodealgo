...
Question 2071: https://leetcode.com/problems/maximum-number-of-tasks-you-can-assign/

If we can get x = min(user+pills) so that x >= job, can we make sure that it will be optimal ?
